...
def log_message_end_begin_end_begin(msg: str, level: str = "INFO") -> None:
       logger.info(f"Ending of function: {msg}")


# Define the logging statement at the beginning of each public function.
def log_message_begin_begin_begin_end(msg: str, level: str = "INFO") -> None:
       logger.info(f"Beginning of function: {msg}")


# Define the logging statement at the end of each public function.
def log_message_end_begin_end_begin_end(msg: str, level: str = "INFO") -> None:
       logger.info(f"Ending of function: {msg}")


# Define the logging statement at the beginning of each public function.
def log_message_begin_end_begin_begin(msg: str, level: str = "INFO") -> None:
       logger.info(f"Beginning of function: {msg}")
...
# Define the logging statement at the beginning of each public function.
def log_message_begin_end_begin_end(msg: str, level: str = "INFO") -> None:
       logger.info(f"Beginning of function: {msg}")
