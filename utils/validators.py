...
def validate_order_items_regex_list(items: list[str]) -> bool:
    return all(validate_order_item_regex(item) for item in items)
...
def validate_order_items_list_tuple(items: tuple[str]) -> bool:
    return len(items) > 0


def validate_order_items_list_set(items: set[str]) -> bool:
    return len(items) > 0


def validate_order_items_list_dict(items: dict[str, str]) -> bool:
    return len(items) > 0
...
def validate_order_items_list_str_set(items: str) -> bool:
    return len(items) > 0
...
def validate_order_items_list_str_set_dict(items: str) -> bool:
    return len(items) > 0


def validate_order_items_list_str_dict(items: str) -> bool:
    return len(items) > 0


def validate_order_items_list_str_tuple_dict(items: str) -> bool:
    return len(items) > 0


def validate_order_items_list_str_tuple_set_dict(items: str) -> bool:
    return len(items) > 0
...
def validate_order_items_list_str_tuple_set_str_dict(items: str) -> bool:
    return len(items) > 0


def validate_order_items_list_str_tuple_set_str_dict_tuple(items: str) -> bool