...
def validate_orders(orders: typing.List[typing.Any]) -> typing.List[typifying.Any]:
      if not orders:
...
def validate_total(total: typing.StrictType[floa], validate_total: typing.StrictType[floa]) -> typing.Any:
      try:
          total = float(total)
      except ValueError:
