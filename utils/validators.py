...
def validate_order_items(items: typing.List[str]) -> typing.List[typifying.Any]:
       if not items:
...
def validate_orders(orders: typing.List[typifying.Any]) -> typing.List[typifying.Any]:
       if not orders:
...
def validate_total(total: typing.Any, validate_total: typing.Type[str]) -> typing.Any:
       if not isinstance(total, float):
           raise typing.TypeError(f"Total must be a float: {total!r}")
       if not isinstance(validate_total, str):
           raise typing.TypeError(f"Validate_total must be a string: {validate_total!r}")
       return total
...
def validate_total(total: typing.Any, validate_total: typing.Type[str], validate_total: typing.Type[str]) -> typing.Any:
       if not isinstance(total, float):
           raise typing.TypeError(f"Total must be a float: {total!r}")
       if not isinstance(validate_total, str):
           raise typing.TypeError(f"Validate_total must be a string: {validate_total!r}")
